...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-add12aa7.js"), true ? ["assets/search-docs-data-add12aa7.js","assets/vendor-cd99ff8b.js"] : void 0);
    function close() {
      emit("close");
    }
    const input = ref();
