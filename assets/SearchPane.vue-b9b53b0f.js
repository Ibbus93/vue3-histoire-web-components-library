import { _ as __vitePreload } from "./GenericMountStory.vue2-abc7658f.js";
import { d as defineComponent, o as openBlock, b as createElementBlock, a5 as renderSlot, n as normalizeClass, m as withKeys, c as computed, q as createBlock, g as unref, I as Icon, e as createVNode, f as createBaseVNode, z as createTextVNode, t as toDisplayString, F as Fragment, p as renderList, h as createCommentVNode, u as useCssVars, r as ref, $ as toRefs, a1 as useRouter, w as withCtx, X as markRaw, k as watch, aA as useFocus, aB as refDebounced, y as withDirectives, a6 as vModelText, a4 as withModifiers, aC as flexsearch_bundleExports } from "./vendor-ca32ff3f.js";
import { _ as _export_sfc, u as useScrollOnActive, B as BaseListItemLink, a as useStoryStore } from "./MobileOverlay.vue2-1edec3c2.js";
import { B as BaseEmpty } from "./BaseEmpty.vue-72459b86.js";
import { o as onKeyboardShortcut, u as useCommandStore } from "./bundle-main-9ca2c90f.js";
...
let searchData$1 = { "index": { "reg": '{"0":1,"1":1}', "text.cfg": '{"doc":0,"opt":1}', "text.map": '[{"p":[0,1],"pa":[0,1],"pas":[0,1],"pase":[0,1]},{"po":[0,1],"pot":[0,1],"poto":[0,1],"potom":[0,1]},{"t":[1],"te":[1],"tef":[1],"tefa":[1],"tefao":[1],"tefaol":[1],"tefaolt":[1]},{},{},{},{},{},{}]', "text.ctx": "[{}]" }, "idMap": { "0": { "id": "src-components-basebutton-basebutton-story-vue", "kind": "story" }, "1": { "id": "src-components-basebutton-basebutton-story-vue:_default", "kind": "variant" } } };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-cb473416.js"), true ? ["assets/search-docs-data-cb473416.js","assets/vendor-ca32ff3f.js"] : void 0);
    function close() {
      emit("close");
    }
    const input = ref();
